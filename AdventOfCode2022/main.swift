...
//Day6
//let result = Day6().solution1(inputLoader.loadFileAsString("day_6.txt"))
//let result = Day6().solution2(inputLoader.loadFileAsString("day_6.txt"))

//Day7
//let result = Day7().solution1(inputLoader.loadFileAsString("day_7.txt"))
//let result = Day7().solution2(inputLoader.loadFileAsString("day_7.txt"))

//Day8
//let result = Day8().solution1(inputLoader.loadFileAsString("day_8.txt"))
//let result = Day8().solution2(inputLoader.loadFileAsString("day_8.txt"))

//Day9
//let result = Day9().solution1(inputLoader.loadFileAsString("day_9.txt"))
//let result = Day9().solution2(inputLoader.loadFileAsString("day_9.txt"))

//Day10
//let result = Day10().solution1(inputLoader.loadFileAsString("day_10.txt"))
//let result = Day10().solution2(inputLoader.loadFileAsString("day_10.txt"))
...
//day 13
//let result = try Day13().solution1(inputLoader.loadFileAsString("day_13.txt"))
let result = try Day13().solution2(inputLoader.loadFileAsString("day_13.txt"))
print(result)
